<fieldset class="board-title-form">
    ...
    <input id="board-title-form" type="title" name="title" value="{{old('title', $free->title)}}" >
    @if ($errors->has('title'))
...
<fieldset class="board-content-form">
    ...
    <textarea id="board-content-form" name="content">{{old('content', $free->content)}}</textarea>
