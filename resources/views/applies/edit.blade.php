...
@section('content')
    <div class="apply">
        <form method="POST" action="{{route('applies.update', $apply->id)}}">
            {!! csrf_field() !!}
            {!! method_field('put') !!}
            <div class="subject_info">
                ...
                <fieldset>
                    ...
                    <input id="applyAge"type="text" name="applyAge" value="{{old('applyAge', $apply->applyAge)}}">
                </fieldset>
                ...
                <fieldset>
                    ...
                    <select id="applyGender" name="applyGender">
                        <option selected>{{old('applyGender', $apply->applyGender)}}</option>
                        <option>여</option>
                        <option>남</option>
                    </select>
                </fieldset>
                ...
                <fieldset>
                    ...
                    <select id="applyJapanese" name="applyJapanese">
                        <option selected>{{old('applyJapanese', $apply->applyJapanese)}}</option>
                        <option>상</option>
                        <option>중</option>
                        <option>하</option>
                    </select>
                ...
                <fieldset>
                    ...
                    <select id="applyVisa" name="applyVisa">
                        <option selected>{{old('applyVisa', $apply->applyVisa)}}</option>
                        <option>유학비자</option>
                ...
                <fieldset>
                    ...
                    <select id="applyHistory" name="applyHistory">
                        <option selected>{{old('applyHistory', $apply->applyHistory)}}</option>
                        <option>1년 미만</option>
                        <option>1년~2년</option>
                        <option>2년~3년</option>
                        <option>3년~4년</option>
                ...
                <fieldset>
                    ...
                    <input id="applySns" type="text" name="applySns" value="{{old('applySns', $apply->applySns)}}">
                </fieldset>
